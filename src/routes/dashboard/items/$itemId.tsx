...
import { getItemsById, saveSummaryAndGenerateTagsFn } from '#/data/items'
...
export const Route = createFileRoute('/dashboard/items/$itemId')({
  ...
  loader: ({ params }) => getItemsById({ data: { id: params.itemId } }),
  head: ({ loaderData }) => ({
    meta: [
      {
      ...
      {
        property: 'og:image',
        content: loaderData?.ogImage ?? 'lorem',
      },
      {
        name: 'twitter:title',
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 w-full">
      ...
      <div className="space-y-3">
        ...
        {/* when need to redirect to an external website use "a" ,for internal redirect use "Link" */}
        <a
          href={data.url}
